...
100	500	Argos	0	10% OFF Purchase
101	700	Sainsburys	0	$5 OFF for in-store groceries
102	900	Iceland	0	$8 OFF Purchase
103	1500	Aldi	0	50% OFF Purchase
104	2000	KFC	0	FREE ORIGINAL CHICKEN
\.
...
SELECT pg_catalog.setval('public.transaction_id_seq', 1006, true);
